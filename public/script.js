...
(function () {
  ...
  const translations = {
    fr: {
      ...
      'proc-3-h': 'Développement', 'proc-3-p': 'On code votre site avec les dernières technologies. Vous suivez l\'avancement en temps réel sur notre espace client.', 'proc-3-d': '⏱ Jours 3 et 4',
      'proc-4-h': 'Mise en ligne', 'proc-4-p': 'Votre site est publié, testé et optimisé. On reste disponibles pour la suite, avec formation à la prise en main incluse si vous avez choisi la livraison WordPress.', 'proc-4-d': '⏱ Jour 4',
      ...
      'faq-1-a': 'Dès réception de vos contenus et du premier acompte, on démarre immédiatement. <strong>Jour 1 :</strong> brief & maquette. <strong>Jour 2 :</strong> validation & développement. <strong>Jours 3 et 4 :</strong> finalisation, tests et mise en ligne. Simple, rapide, garanti contractuellement.',
      ...
      'faq-5-a': 'Ça dépend du mode de livraison choisi. En <strong>sur-mesure</strong> (l\'offre par défaut), on vous remet tous les fichiers sources de votre site : pour les modifications de contenu, notre maintenance est là, 2 demandes par mois incluses, réponse sous 48h. Si vous préférez garder la main directement, chaque formule peut aussi être livrée sur <strong>WordPress</strong> (+250€) : vous modifiez alors textes, images et pages vous-même, en glisser-déposer, sans dépendre d\'un développeur à chaque changement. Une formation à la prise en main est incluse à la livraison.',
      ...
      'faq-7-q': 'Avec quelle technologie développez-vous mes sites ?',
      'faq-7-a': 'Ça dépend de vos besoins. Par défaut, on code chaque site à la main, sans thème ni page recyclée : c\'est ce qui nous permet d\'aller loin sur la vitesse et le référencement. Si vous voulez pouvoir modifier votre site vous-même après la livraison (textes, images, nouvelles pages), on peut aussi le construire sur <strong>WordPress</strong>, avec une interface glisser-déposer et une formation incluse. On travaille aussi avec Wix ou des outils comme Lovable quand le projet s\'y prête. Dans tous les cas, le design reste pensé sur-mesure pour votre activité, jamais un template générique.',
    ...
    en: {
      ...
      'proc-3-h': 'Development', 'proc-3-p': 'We build your site with the latest technologies. Track progress in real time on our client portal.', 'proc-3-d': '⏱ Days 3 and 4',
      'proc-4-h': 'Launch', 'proc-4-p': 'Your site is published, tested and optimized. We stay available afterwards, with hands-on training included if you chose WordPress delivery.', 'proc-4-d': '⏱ Day 4',
      ...
      'faq-1-a': 'As soon as we receive your content and first payment, we start immediately. <strong>Day 1:</strong> brief & mockup. <strong>Day 2:</strong> validation & development. <strong>Days 3 and 4:</strong> finalization, testing and launch. Simple, fast, contractually guaranteed.',
      ...
      'faq-5-a': 'It depends on the delivery method you choose. With <strong>custom code</strong> (our default offer), we hand over all your site\'s source files: for content changes, our maintenance plan is there, 2 requests per month included, replies within 48h. If you\'d rather manage things yourself, every plan can also be delivered on <strong>WordPress</strong> (+250€): you then edit texts, images and pages yourself, with drag-and-drop, without depending on a developer for every change. Hands-on training is included at delivery.',
      ...
      'faq-7-q': 'What technology do you use to build my site?',
      'faq-7-a': 'It depends on what you need. By default, we hand-code every site, no theme or recycled page, which is what lets us push hard on speed and SEO. If you want to be able to update your site yourself after delivery (text, images, new pages), we can also build it on <strong>WordPress</strong>, with a drag-and-drop interface and training included. We also work with Wix or tools like Lovable when the project calls for it. Either way, the design stays custom-made for your business, never a generic template.',
