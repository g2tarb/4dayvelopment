...
export function lintGate(briefs) {
  ...
  briefs.forEach((b, i) => {
    ...
    FIELDS.forEach((f) => {
      ...
      if (AI_TELLS.some((p) => p.test(v))) warnings.push(`${d}_${f}_tell_ia`);
    });
